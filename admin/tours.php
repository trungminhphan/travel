            ...
            <table id="data-table" class="table table-striped table-bordered table-hovered">
                ...
                if($list){
                	...
                	foreach ($list as $ds) {
                		...
                		echo '<td class="text-center"><a href="themtours.html?id='.$ds['_id'].'&act=del" onclick="return confirm(\'Chắc chắn muốn xóa?\')"><i class="fa fa-trash"></i></a></td>';
                        echo '<td class="text-center"><a href="themtours.html?id='.$ds['_id'].'&act=edit"><i class="fa fa-pencil"></i></a></td>';
                		echo '</tr>';$i++;
                	}
                }
                ?>
