...
if($id && $act=='del'){
    ...
    if($tuvanvisa->delete()) transfers_to('tuvanvisa.html?msg=Xóa thành công!');
}
$list = $tuvanvisa->get_all_list();
if($id && $act == 'edit'){
    $tuvanvisa->id = $id; $t = $tuvanvisa->get_one();
    $tieude = $t['tieude'];
    $mota = $t['mota'];
...
if(isset($_POST['submit'])){
    ...
    $tuvanvisa->id_danhmuctuvanvisa = $id_danhmuctuvanvisa;
    $tuvanvisa->tieude = $tieude;
    $tuvanvisa->mota = $mota;
    $tuvanvisa->noidung = $noidung;
    $tuvanvisa->hinhanh = $arr_hinhanh;
    $tuvanvisa->hienthi = $hienthi;
    $tuvanvisa->video = $video;
    $tuvanvisa->orders = $orders;
	...
	<div class="col-md-12">
		<div class="panel panel-primary">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <span class="btn btn-primary fileinput-button">
                            ...
                            <span>Chọn hình ảnh tốt nhất (800px x 562px)...</span>
            ...
            <div class="panel-footer">
                <a href="tuvanvisa.html" class="btn btn-white"><i class="fa fa-reply-all"></i> Trở về</a>
